...
class Connect extends ControllerBase {
  ...
  public function getToken() {
	  ...
	  try {
        ...
        return new RedirectResponse(Url::fromRoute('ecwid.connect')->setRouteParameter('error','access_denied')->toString()); 
      }
    ...
    return new RedirectResponse(Url::fromRoute('ecwid.control-panel')->toString());
	}
